...
#ifndef TABLEVIEW_SWIFT_H
#define TABLEVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="tableView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9tableView21AddNoteViewController")
@interface AddNoteViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified myTitle;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified subtitle;
- (void)viewDidLoad;
- (void)saveNote;
...
SWIFT_CLASS("_TtC9tableView13SceneDelegate")
...
SWIFT_CLASS("_TtC9tableView14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(tableView)) <UITableViewDataSource>
...
@interface ViewController (SWIFT_EXTENSION(tableView)) <UITableViewDelegate>
